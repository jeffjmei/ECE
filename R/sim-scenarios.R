scenario1 <- function(n = 1000, p = 2, r = 0, amp = 1, type = "compound", seed = 1) {
  # no change point
  list(
    scenario       = 1,
    h              = matrix(0, n, p),
...
scenario2 <- function(n = 1000, p = 2, r = 0, amp = 1, type = "compound", seed = 1, L = n / 2) {
...
scenario3 <- function(n = 1000, p = 2, r = 0, amp = 1, type = "compound", seed = 1, period = 365) {
  # sin wave
...
scenario <- function(scenario_num = 1, n = 1000, p = 2, r = 0, amp = 1, type = "compound", seed = 1, ...) {
