...
**Could it be time-jumps?** This data contains large blocks of missing data. 
...
When you look at individual years, the missing data does not show up as prevalently. Nevertheless, the **negative auto-correlation persists**.
