...
Overall, this analysis supports the notion that ECE may not be well-equipped to handle random-walk time series such as stock data. 

# More Work
- simulate whether the residual consistently estimates the true variance
- histogram of the covariance matrix 
- [x] strategy: take first difference as pre-processing step
  - Doesn't work. No longer a change point problem
- [x] compare this against a model that is not misspecified
